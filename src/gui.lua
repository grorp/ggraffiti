    ...
    return gui.VBox {
        ...
        color and gui.HBox {
            ...
            gui.VBox {
                ...
                gui.Label {
                    label = S("R: @1, G: @2, B: @3", color.r, color.g, color.b),
                },
            },
            gui.Image {
                w = 0.8,
...
gui_change_rgb_color = flow.make_gui(function(_, ctx)
    ...
    return gui.VBox {
        ...
        gui.Label {
            label = ctx.initial_setup and S("Set Color") or S("Change Color"),
        },
        gui.VBox {
            spacing = FORMSPEC_LOWSPACING,
            gui.HBox {
            ...
            gui.Label { label = S("Values must be integers between 0 and 255.") },
        },
        gui.VBox {
            spacing = 0,
            ...
            gui.HBox {
                spacing = FORMSPEC_SPACING,
                preview_color and gui.Image {
                    w = 0.8,
                    h = 0.8,
                    expand = true,
                    align_h = "fill",
                    texture_name = make_color_texture(preview_color),
                } or gui.Nil {},
                gui.Button {
                    label = S("Update"),
                    expand = not preview_color or nil,
                    align_h = not preview_color and "right" or nil,
                    -- no on_event needed
                },
            },
        },
